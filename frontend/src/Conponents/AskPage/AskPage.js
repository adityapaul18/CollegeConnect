        ...
        <div className="AskPageContainer">
            <div className="ProfileLeft">
                <div className="AskBox" >
                    ...
                    <TextField className="AskHeaders" variant="outlined" label="Description" multiline rows={10}
                        onChange={(e) => {
                    ...
                    <input className="AskHeaders hider" ref={ref} variant="outlined" type="file" onChange={(e) => setImages(e.target.files)} />
